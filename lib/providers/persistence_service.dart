...
class PersistenceService {
  ...
  static Map<String, dynamic> _itemToJson(OrderItem item) {
    return {
      ...
      'deliveryPromiseSub': item.deliveryPromiseSub,
      ...
      'shopDiscountLabel': item.shopDiscountLabel,
      'showStyleBtn': item.showStyleBtn,
      'showPlatformCoupon': item.showPlatformCoupon,
      'payDiscount': item.payDiscount,
      'payDiscountLabel': item.payDiscountLabel,
      'showPayDiscount': item.showPayDiscount,
      ...
      'waybillBorrowed': item.waybillBorrowed,
      'shipLogo': item.shipLogo,
  ...
  static OrderItem _itemFromJson(Map<String, dynamic> j) {
    return OrderItem(
      ...
      deliveryPromiseSub: j['deliveryPromiseSub'] ?? '',
      ...
      shopDiscountLabel: j['shopDiscountLabel'] ?? '超级立减',
      showStyleBtn: j['showStyleBtn'] ?? false,
      showPlatformCoupon: j['showPlatformCoupon'] ?? true,
      payDiscount: (j['payDiscount'] as num?)?.toDouble() ?? 0,
      payDiscountLabel: j['payDiscountLabel'] ?? '',
      showPayDiscount: j['showPayDiscount'] ?? false,
